                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">${{ number_format($totalEarnings, 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">${{ number_format($activeFarming, 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>

    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-white tracking-tight leading-tight">
                    Choose Your
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Daily Returns</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300">0.50% daily farming rewards</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl p-6 text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Binary System</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Left/Right leg matching bonuses</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">300% ROI Cap</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Guaranteed 3X return on investment</p>
                </div>

                <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-orange-600 rounded-lg flex items-center justify-center mx-auto mb-4">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Verified Assets</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300">Real flower tea backed tokens</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-16">
                ...
                <div class="relative group">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700 overflow-hidden h-full flex flex-col">
                        <!-- Header -->
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            <div class="space-y-4 mb-8 flex-1">
                                <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 dark:text-gray-300 font-medium">Binary Points</span>
                                    </div>
                                    <span class="font-bold text-gray-900 dark:text-white">{{ $package->points }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 dark:text-gray-300 font-medium">Daily Pairs Limit</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 dark:text-gray-300 font-medium">Pairing Bonus</span>
                                    </div>
                            ...
                            <div class="space-y-3 mt-auto">
                                <a href="{{ route('packages.show', $package) }}"
                                   class="block w-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-semibold py-3 px-4 rounded-xl transition-colors duration-200 text-center">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-8 lg:p-12">
                <div class="text-center mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center group">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Choose Your Package</h3>
                    ...
                    <div class="text-center group">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Make Secure Payment</h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    <div class="text-center group">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Start Earning</h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">What is the binary compensation system?</h3>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">How does farming work?</h3>
                        <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Are there any risks?</h3>
                        <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">When can I withdraw earnings?</h3>
                        <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">

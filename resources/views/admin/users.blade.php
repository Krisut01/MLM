                    ...
                    <table class="min-w-full">
                        <thead class="bg-gray-50 dark:bg-gray-900/40">
                            <tr>
                                ...
                                <th class="text-left text-xs font-semibold text-gray-600 dark:text-gray-300 px-6 py-3">Email</th>
                                <th class="text-left text-xs font-semibold text-gray-600 dark:text-gray-300 px-6 py-3">Admin</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($users as $u)
                                <tr>
                                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 font-semibold">{{ $u->name }}</td>
